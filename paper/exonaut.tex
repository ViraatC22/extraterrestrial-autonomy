...
lunar condition and the out-of-distribution Martian condition. Smaller is
better.}
...
\caption{How missions ended. The mechanism behind the headline numbers is
visible here as a shift between termination causes rather than a uniform
improvement.}
\end{figure}
